#
# Module manifest for module 'GetRandomString'
#
...
RootModule = 'GetRandomString.psm1'
...
GUID = 'af66587d-6864-4682-8ff5-d34dc8ff1ab9'
...
FunctionsToExport = @("Get-Random-String")
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("scripting","security","random")
