#
# Module manifest for module 'ServiceBusCommander'
#
# Generated by: Yasen Dinkov
#
# Generated on: 11/4/2022
#
...
GUID = '56bcd062-4ca5-4bd0-a603-346cf193f371'
...
FunctionsToExport = @("Send-QueueMessage","Send-QueueMessages")

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
#CmdletsToExport = @("Send-QueueMessages")
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("azure", "service-bus", "messaging", "devops", "automation")
        ...
        IconUri = 'https://raw.githubusercontent.com/ydinkov/CmdletCarnaval/master/ServiceBusCommander/logo.png'
